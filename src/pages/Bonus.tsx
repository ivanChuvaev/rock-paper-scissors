...
const variants = ['SCISSORS', 'PAPER', 'ROCK', 'LIZARD', 'SPOCK'] as const
type TVariant = typeof variants[number]

const winMap: Record<TVariant, [TVariant, TVariant]> = {
...
const calculateWinner = (your: TVariant, computer: TVariant): 'NONE' | 'YOU' | 'COMPUTER' => {
  ...
  return winMap[your].includes(computer) ? 'YOU' : 'COMPUTER' 
}
